...
|:--|
| **Stats.** Level reached, total stars, win rate, bonks/falls, streak, and a **command-usage bar chart** so you can see which powers a kid actually leans on. Up top: **Badges 7/16** (tap it to open the gallery). From here you can **Edit** name/colour, **Draw** a custom sprite, open the **Shop**, or (behind two confirmations) delete the player. |
