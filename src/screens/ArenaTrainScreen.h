...
class ArenaTrainScreen : public app::IScreen {
 ...
 private:
  ...
  static constexpr int PATH_N = 12;  // traced-route samples (trimmed to free static DRAM)
  ...
  static constexpr int CURVE_N = 4;    // sparkline samples (trimmed to free static DRAM)
