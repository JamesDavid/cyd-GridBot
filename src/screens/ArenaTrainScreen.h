...
class ArenaTrainScreen : public app::IScreen {
 public:
  ...
  gb::MatchType fightType() const { return _matchType; }  // Race / Sumo / Soccer to launch into
 ...
 private:
  ...
  static constexpr int PATH_N = 16;  // traced-route samples (trimmed to free static DRAM)
  ...
  static constexpr int CURVE_N = 6;    // sparkline samples (trimmed to free static DRAM)
