...
static const LessonInfo LESSONS[N_LESSONS] = {
  ...
  {"10. Memory", "an RNN remembers", C_ACCENT},
  {"11. Perception", "raw squares -> meaning", C_MOVE},
  {"12. Data", "learn from examples", C_SENSE},
  {"13. Backprop", "learn one step at a time", C_MOVE},
};
