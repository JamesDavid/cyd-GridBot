...
// soccer=true relabels the inputs/outputs for the soccer sense layout (ball/net/rival; output 4 = swap).
...
// 8-9 = rival bearing; output 4 is the ball-SWAP (fire facing the ball -> trade places with it).
