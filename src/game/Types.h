...
// only walls at each end are the top/bottom corners -- a bot can't get pinned in a flanking-wall
// corner next to the goal. Shared by the pitch generator, the match engine, training, and rendering.
constexpr int SOCCER_MOUTH_LO = -3, SOCCER_MOUTH_HI = 2;
